...
CMakeFiles/test-socket-server.dir/test/test-socket-server.c.o: ../test/test-socket-server.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/cygdrive/e/code/algorithm/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object CMakeFiles/test-socket-server.dir/test/test-socket-server.c.o"
	/usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test-socket-server.dir/test/test-socket-server.c.o   -c /cygdrive/e/code/algorithm/test/test-socket-server.c
...
CMakeFiles/test-socket-server.dir/test/test-socket-server.c.i: cmake_force
	...
	/usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /cygdrive/e/code/algorithm/test/test-socket-server.c > CMakeFiles/test-socket-server.dir/test/test-socket-server.c.i
...
CMakeFiles/test-socket-server.dir/test/test-socket-server.c.s: cmake_force
	...
	/usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /cygdrive/e/code/algorithm/test/test-socket-server.c -o CMakeFiles/test-socket-server.dir/test/test-socket-server.c.s
...
test-socket-server.exe: CMakeFiles/test-socket-server.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/cygdrive/e/code/algorithm/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable test-socket-server.exe"
...
CMakeFiles/test-socket-server.dir/depend:
	cd /cygdrive/e/code/algorithm/cmake-build-debug && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /cygdrive/e/code/algorithm /cygdrive/e/code/algorithm /cygdrive/e/code/algorithm/cmake-build-debug /cygdrive/e/code/algorithm/cmake-build-debug /cygdrive/e/code/algorithm/cmake-build-debug/CMakeFiles/test-socket-server.dir/DependInfo.cmake --color=$(COLOR)
